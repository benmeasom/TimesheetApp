        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimesheetUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Timesheet", x => x.TimesheetId);
                    table.ForeignKey(
                        name: "FK_Timesheet_AspNetUsers_TimesheetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TimesheetItemsId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TimesheetId = table.Column<long>(nullable: false),
                    ActivityId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimesheetItems", x => x.TimesheetItemsId);
                    table.ForeignKey(
                        name: "FK_TimesheetItems_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "ActivityId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimesheetItems_Timesheet_TimesheetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheet_TimesheetUserId",
                table: "Timesheet",
                column: "TimesheetUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TimesheetItems_ActivityId",
